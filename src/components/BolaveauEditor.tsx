...
function getDemoScene(projectId: string): { nodes: Record<string, Record<string, unknown>>; rootNodeIds: string[] } | null {
  ...
  nodes[siteId] = {
    id: siteId, type: 'site', visible: true, metadata: { name: 'South Fifty Seven HQ' },
    children: [buildingId],
  }

  nodes[buildingId] = {
    id: buildingId, type: 'building', parentId: siteId, visible: true,
  ...
  nodes[groundFloorId] = {
    id: groundFloorId, type: 'level', parentId: buildingId, visible: true,
    ...
    elevation: 0, height: 3.2, level: 0, name: 'Ground Floor',
  }

  nodes[secondFloorId] = {
    id: secondFloorId, type: 'level', parentId: buildingId, visible: true,
    metadata: { name: 'Second Floor' },
    children: [],
    elevation: 3.2, height: 3.2, level: 1, name: 'Second Floor',
  }

  nodes[receptionZoneId] = {
    id: receptionZoneId, type: 'zone', parentId: groundFloorId, visible: true,
    metadata: { name: 'Reception', area: 180 },
    children: [receptionDeskId, sofaId], name: 'Reception', color: '#c9a84c',
  }

  nodes[conferenceZoneId] = {
    id: conferenceZoneId, type: 'zone', parentId: groundFloorId, visible: true,
    metadata: { name: 'Conference Room', area: 280 },
    children: [conferenceTableId], name: 'Conference Room', color: '#3b82f6',
  }

  nodes[office1ZoneId] = {
    id: office1ZoneId, type: 'zone', parentId: groundFloorId, visible: true,
    metadata: { name: 'Private Office', area: 150 },
    children: [officeDeskId], name: 'Private Office', color: '#22c55e',
  }

  nodes[breakRoomZoneId] = {
    id: breakRoomZoneId, type: 'zone', parentId: groundFloorId, visible: true,
    metadata: { name: 'Break Room / Kitchen', area: 200 },
    children: [kitchenCounterId], name: 'Break Room / Kitchen', color: '#f59e0b',
  }

  // Walls
  nodes[wallOuterId] = {
    id: wallOuterId, type: 'wall', parentId: groundFloorId, visible: true,
    metadata: {}, children: [],
    start: [0, 0], end: [15, 0], thickness: 0.2, height: 3.2, material: 'concrete',
  }
  nodes[wallReceptionId] = {
    id: wallReceptionId, type: 'wall', parentId: groundFloorId, visible: true,
    metadata: {}, children: [],
    start: [5, 0], end: [5, 8], thickness: 0.15, height: 3.2, material: 'drywall',
  }
  nodes[wallConfId] = {
    id: wallConfId, type: 'wall', parentId: groundFloorId, visible: true,
    metadata: {}, children: [],
    start: [10, 0], end: [10, 8], thickness: 0.15, height: 3.2, material: 'drywall',
  }
  nodes[wallOffice1Id] = {
    id: wallOffice1Id, type: 'wall', parentId: groundFloorId, visible: true,
    metadata: {}, children: [],
  ...
  nodes[receptionDeskId] = {
    id: receptionDeskId, type: 'item', parentId: groundFloorId, visible: true,
    metadata: { name: 'Reception Desk', category: 'furniture' }, children: [],
    position: [2.5, 3], rotation: 0, asset: { category: 'furniture', name: 'Reception Desk' },
  }
  nodes[conferenceTableId] = {
    id: conferenceTableId, type: 'item', parentId: groundFloorId, visible: true,
    metadata: { name: 'Conference Table', category: 'furniture' }, children: [],
    position: [12.5, 4], rotation: 0, asset: { category: 'furniture', name: 'Conference Table' },
  }
  nodes[officeDeskId] = {
    id: officeDeskId, type: 'item', parentId: groundFloorId, visible: true,
    metadata: { name: 'Office Desk', category: 'furniture' }, children: [],
    position: [2.5, 4.5], rotation: 0, asset: { category: 'furniture', name: 'Office Desk' },
  }
  nodes[sofaId] = {
    id: sofaId, type: 'item', parentId: groundFloorId, visible: true,
    metadata: { name: 'Waiting Sofa', category: 'furniture' }, children: [],
    position: [4, 1.5], rotation: 0, asset: { category: 'furniture', name: 'Waiting Sofa' },
  }
  nodes[kitchenCounterId] = {
    id: kitchenCounterId, type: 'item', parentId: groundFloorId, visible: true,
    metadata: { name: 'Kitchen Counter', category: 'appliance' }, children: [],
    position: [13.5, 1], rotation: 0, asset: { category: 'appliance', name: 'Kitchen Counter' },
  }
